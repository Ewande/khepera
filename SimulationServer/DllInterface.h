...
extern "C" __declspec(dllexport) unsigned int getRobotCount(Simulation* simulation);
...
extern "C" __declspec(dllexport) unsigned int getSensorCount(KheperaRobot* robot);
